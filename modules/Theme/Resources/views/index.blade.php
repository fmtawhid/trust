...
{{-- fully working code with 6 theme  --}}
...
{{--- new code hiding theme just 2 theme updated.---}}
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <div class="input-group">
                            <a class="text-decoration-underline text-success"
                                href="{{ route('applications.application') }}">
                                {{ localize('Click here to change the footer background image') }}</a>
                        </div>
                    </div>
                </div>
                <div class="row mb-3">
...
{{--- new code  end hiding theme just 2 theme updated.---}}