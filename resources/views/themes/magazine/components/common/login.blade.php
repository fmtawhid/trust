...
<div class="h-auto max-w-md mx-auto p-6 bg-white dark:bg-neutral-800 shadow-md rounded-lg">
    ...
    <div class="space-y-4">
        ...
        <a href="{{ __url('registration') }}" class="block text-center text-sm text-red-600 dark:text-red-400 hover:underline mt-2">
            {{ localize('or_register_with_email') }}
        </a>

        <div id="responseMessage" class="text-sm text-center text-red-500"></div>
        ...
        <form id="loginForm" class="space-y-4">
            ...
            <div class="text-right">
                <a class="text-sm text-red-600 dark:text-red-400 hover:underline" href="{{ route('web.forgot.password') }}">
