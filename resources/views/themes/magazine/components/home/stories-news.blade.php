<section class="container my-6">
    <div class="border-y dark:border-y-neutral-600 py-4">
        <div class="mb-4">
            <a href="{{ __url('web-stories') }}"
                class="inline-block text-theme-three dark:text-white text-lg font-semibold uppercase pb-1  relative before:absolute before:left-0 rtl:before:left-auto rtl:before:right-0 before:h-1 before:bg-theme-three dark:before:bg-white before:z-10 before:-bottom-[3px] before:w-full md:before:w-20 mb-4 md:mb-0">
        ...
        <div class="swiper w-full h-full StoriesNewsSwiper">
            ...
            <button type="button"
                class="swiper_button_prev stories-swiper-button-prev rtl:order-2 absolute top-1/2 left-2 z-10">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 20 20"
                    fill="none">
                    <path d="M13.1,13.9L9.2,10l3.9-3.8L11.9,5l-5,5l5,5L13.1,13.9z" fill="#ffffff" />
                </svg>
            </button>
            <button type="button" class="swiper_button_next stories-swiper-button-next absolute top-1/2 right-2 z-10">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 20 20"
                    fill="none">
                    <path
