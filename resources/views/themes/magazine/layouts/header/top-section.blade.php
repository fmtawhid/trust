...
<section
    ...
    <div class="container mx-auto py-2 flex justify-between items-center">
        ...
        @php
        use Carbon\Carbon;
        $formattedDate = Carbon::now()->format('l, d F Y'); // English
        $banglaDate = bangla_date(); // Bangla
        @endphp
        ...
        <section class="hidden xl:flex items-center gap-8">
            <div class="flex items-center gap-1 text-neutral-700 dark:text-white">
                ...
                <span class="text-sm">{{ $banglaDate }}</span>
            </div>
        </section>
        {{-- Mobile Brand Logo  --}}
    ...
    display: none !important;
        ...
        <section class="flex items-center gap-2 md:gap-4">
            ...
            @if (app_setting()->web_user_can_login == 1)
               @include('themes.magazine.components.common.login-button')
            @endif
