        ...
        <div class="hidden lg:block side-bar">
            <div class="menu flex items-center gap-2 xl:gap-4">
                <div class="item relative cursor-pointer py-2">
                    <a class="capitalize @if (!$themeSettings->text_color) text-white @endif flex justify-start items-center hover:transition_3 side_nav_magazine"
                    ...
                    @if ($menu->submenus->isNotEmpty())
                        <div class="item cursor-pointer py-2">
                            <a href="{{ __url($menu->slug) }}"
                                class="sub-btn @if (!$themeSettings->text_color) text-white @endif flex justify-start items-center hover:transition_3 hover:text-red-600 active:text-red-600 side_nav_magazine"
                            ...
                            <div
                                class="sub-menu max-h-0 overflow-hidden transition-max-height duration-300 ease-in-out bg-neutral-50 dark:bg-neutral-800 absolute top-full left-7 w-[96%] shadow-md z-99">
                ...
                <div class="item cursor-pointer py-2 relative">
                    <!--<a class="sub-btn @if (!$themeSettings->text_color) text-white @endif flex justify-start items-center hover:transition_3 hover:text-red-600 active:text-red-600 side_nav_magazine"-->
                    ...
                    <!--</a>-->
                    <div
                        class="sub-menu overflow-hidden max-h-0 transition-max-height duration-300 ease-in-out bg-white dark:bg-neutral-800 absolute top-[calc(100%+4px)] left-0 w-max shadow-md z-99 dark:text-white">
                            ...
                            @foreach ($pageMenus as $page)
                                @if ($page->pagesubmenus->isNotEmpty())
                                    <li class="py-2 isolate relative overflow-hidden inner_menu">
                                        ...
                                        <ul
                                            class="inner_sub_menu absolute top-0 left-0 opacity-0 bg-white dark:bg-neutral-700 z-99 max-w-2 w-0 divide-y shadow-md">
